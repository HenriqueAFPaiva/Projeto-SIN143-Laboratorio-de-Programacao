...
<body>
    <div class="pagina">
        ...
        <div class="cad">
            ...
            <div class="content">
                ...
                <div id="cadastro">
                  ...
                  $sql = "SELECT * FROM tipo_hospedagem where ID=$id";
                  ...
                  ?>
                    ...
                    <form action="processa_atualizacao.php" method="post">
                        ...
                        <p>
                            <input id="id" name="ID" type="hidden" value="<?php echo $row_usuario['ID'];?>" />
                        </p>

                        <p>
                            <label for="hostID">ID do host</label>
                            <input id="hostID" name="hostID" required="required" type="text" placeholder="1, 3 ou 4" value="<?php echo $row_usuario['hostID'];?>" />
                        </p>

                        <p>
                            <label for="desc">Descrição da hospedagem</label>
                            <input id="desc" name="descricao" required="required" type="text" placeholder="descrição" value="<?php echo $row_usuario['descricao'];?>" />
                        </p>

                        <p>
                            <label for="titulo">Título da hospedagem</label>
                            <input id="titulo" name="titulo" required="required" type="text" placeholder="titulo" value="<?php echo $row_usuario['titulo'];?>" />
                        </p>
        ...
        <div style="padding-bottom: 150px">
            ...
            echo "<table border='5px solid white'>";
